...
class LoginViewController:UINavigationController,UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        //登录按钮
        let loginButton = UIButton(frame: CGRect(x: vLogin.frame.minX, y: vLogin.frame.maxY + 10, width: ScreenWidth - 30, height: 50))
        ...
        //注册按钮
        let registerButton = UIButton(frame: CGRect(x: loginButton.frame.minX, y: loginButton.frame.maxY + 10, width: ScreenWidth - 30, height: 50))
