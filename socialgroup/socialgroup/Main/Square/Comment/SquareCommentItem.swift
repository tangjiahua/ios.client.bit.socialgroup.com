...
class SquareCommentItem{
    ...
    init(square_item_id:String, square_item_type:String, comment_id:String, user_id:String, user_nickname:String, user_avatar:String, content:String, create_date:String, reply_count:String) {
